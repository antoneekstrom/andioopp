...
public class BuzzyBeetle extends Enemy {
    ...
    public BuzzyBeetle(Rectangle<ModelCoordinate> rectangle) {
        super(SPRITE_PATH, new Health(BASE_HEALTH),rectangle, BASE_SPEED, BASE_ATTACK_COOLDOWN, DAMAGE_FILTER, 5);
    }
}
